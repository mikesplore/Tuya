...
//                                    ?: throw IllegalArgumentException("Invalid TransactionDate string: $value")
//
...
//                val meterPayment = meterPaymentRepository.getPaymentsByMpesaTransactionId(callback.checkoutRequestID)
//
...
//                    )
//
//                    currentTransaction.id?.let { transactionId ->
//                        val meterPayment = meterPaymentRepository.getPaymentsByMpesaTransactionId(transactionId)
//
//                        if (meterPayment != null) {
//                            meterPaymentRepository.updatePaymentStatus(
//                                meterPayment.copy(
...
//                    }
//
//                    val payment = meterPaymentRepository.getPaymentsByMpesaTransactionId(transaction.id?:0)
//
//                    if (payment != null) {
//                        meterPaymentRepository.updatePaymentStatus(
//                            payment.copy(
