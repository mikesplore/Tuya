...
class MeterPayment(id: EntityID<UUID>) : UUIDEntity(id) {
    ...
    var user by User.Companion optionalReferencedOn MeterPayments.userId
    var meter by Meter referencedOn MeterPayments.meterId
    var mpesaTransaction by MpesaTransaction.Companion optionalReferencedOn MeterPayments.mpesaTransactionId
