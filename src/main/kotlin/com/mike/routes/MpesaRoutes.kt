...
//import com.mike.domain.model.mpesa.PaymentRequest
...
//                        val meter = meterService.findById(paymentRequest.meterId)
...
//                                meterService.isMeterAssignedToUser(user.id, paymentRequest.meterId)
...
//                            meterId = paymentRequest.meterId,
//                            userId = user.id?:0,
...
//                        val payments = meterService.getUserPaymentHistory(user.id, limit)
//
...
//                            )
//
//                        val payment = meterService.getPaymentById(paymentId)
...
//
//                        try {
//                            val payments = meterService.getAllPayments()
//                            call.respond(HttpStatusCode.OK, payments)
//                        } catch (e: Exception) {
//                            call.respond(
//                                HttpStatusCode.InternalServerError,
